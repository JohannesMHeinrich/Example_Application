...
\vspace{0.1cm}
I am a physicist experienced in a variety of fields with a passion for programming and automation.

For the last five years I have been working on the design and implementation of state of the art experiments in atomic physics. The control of such experiments requires nanosecond timing, with precise synchronization and configuration of multiple devices. For this task, among others, I use Python.
...
%	\draw[help lines,xstep=.5,ystep=.5, white] (0,0) grid (13,27);
	...
	\begin{itemize}
		\item automation of sympathetically cooled ion detection via imaging by an electron multiplying camera
